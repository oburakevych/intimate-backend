...
import com.intimate.owners.OwnerController;
...
privileged aspect OwnerController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> OwnerController.showJson(@PathVariable("id") String id) {
    ...
    public ResponseEntity<String> OwnerController.deleteFromJson(@PathVariable("id") String id) {
        Owner owner = Owner.findOwner(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (owner == null) {

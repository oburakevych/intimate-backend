...
privileged aspect FileController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> FileController.showJson(@PathVariable("id") String id) {
    ...
    public ResponseEntity<String> FileController.deleteFromJson(@PathVariable("id") String id) {
        File file = File.findFile(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (file == null) {
